...
class CustomerAppTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='naveen', password='kumar1234@', email='gairuboina.naveenkumar45@gmail.com')
        self.profile = Profile.objects.create(user=self.user)

    def test_login_valid_user(self):
        response = self.client.post(self.login_url, {'username': 'naveen', 'password': 'kumar1234@'})
    ...
    def test_login_invalid_user(self):
        ...
        self.assertContains(response, "there is some Issue check your credentials again.")
    ...
    def test_accommodations_submission(self):
        self.client.login(username='naveen', password='kumar1234@')
        response = self.client.post(self.accommodations_url, {'accomodations': 'Request for luxury suite'})
        self.assertEqual(response.status_code, 302)  
